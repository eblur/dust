...
:doc:`galhalo`) from a dust grain size distribution (:doc:`distlib`) and
...
.. autofunction:: astrodust.halos.model_halo.screen
.. autofunction:: astrodust.halos.model_halo.uniform

The following two functions are helpers for integrating up the total
intensity from a **HaloDict** object.

.. autofunction:: astrodust.halos.model_halo.totalhalo
.. autofunction:: astrodust.halos.model_halo.simulate_intensity
...
.. autofunction:: astrodust.halos.model_halo.simulate_screen
.. autofunction:: astrodust.halos.model_halo.simulate_uniform
